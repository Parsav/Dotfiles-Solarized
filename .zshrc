...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(custom_first root_indicator disk_usage dir 
dir_writable vcs virtualenv)

POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status zsh_wifi_signal background_jobs history todo battery load swap time command_execution_time)

POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX=(%B%F{yellow}$'\u256D'$'\U2500'%{%f%})

POWERLEVEL9K_MULTILINE_SECOND_PROMPT_PREFIX=(%F{yellow}$'\u2570'$'\U2500'$(prompt_context left 1)$'\U2500'$'\uE0B1'%k%f )
